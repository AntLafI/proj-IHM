    ...
    ui(new Ui::MainWindow)
{
    ...
    /*
    connect(ui->reloadTheme,&QAction::triggered,
            this,&MainWindow::onActionReloadTheme);
    */
}
...
void MainWindow::reloadTheme(){
    QPalette themePalette = PaletteThemeMapper::paletteFromTheme(Theme::m_currentTheme);
    qApp->setPalette(themePalette);
}
void MainWindow::onActionReloadTheme(){
    reloadTheme();
}
// ======================= SAVE HELPERS =======================
